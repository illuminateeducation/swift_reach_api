...
class AutoFieldSmsTextSource extends AbstractSmsTextSource
{
    ...
    {
        return self::SMS_TEXT_SOURCE_AUTO_FIELD;
    }

    public function toArray()
    {
        return [
            '$type'     => "SwiftReach.Swift911.Core.Messages.SMS.SMS_TEXT_SOURCE_AUTO_FIELD, SwiftReach.Swift911.Core",
